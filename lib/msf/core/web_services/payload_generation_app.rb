...
require 'msf/core/rpc/json/rpc_helper'
require 'msf/core/web_services/framework_extension'
require 'msf/core/web_services/servlet/payload_generation_servlet'

module Msf::WebServices
  class PayloadGenerationApp < Sinatra::Base
    helpers ServletHelper
    helpers Msf::RPC::JSON::RpcHelper
    ...
    register PayloadGenerationServlet
    ...
    configure do
      set :json_rpc_url, ENV.fetch('MSF_WS_JSON_RPC_URL', nil)
      set :json_rpc_token, ENV.fetch('MSF_WS_JSON_RPC_TOKEN', nil)
